...
copyright = '2025'
exclude_patterns = ['**.ipynb_checkpoints', '.DS_Store', '.github/*', 'Thumbs.db', '_build', 'raw_data/*', 'scripts/*', 'venv/*']
...
html_baseurl = ''
html_css_files = ['portfolio-sync.css']
html_favicon = ''
html_js_files = ['portfolio-sync.js']
html_logo = 'logo.png'
...
html_title = 'Crime Hotspot Mapping Analysis'
